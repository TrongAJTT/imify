  ...
  return (
    <div ref={containerRef} className="absolute inset-0">
      <div
        ...
        style={{ backgroundColor: bgColorB || "transparent" }}
      >
      ...
      <div className="pointer-events-none absolute top-3 right-3 z-10 select-none rounded-md bg-slate-900/70 px-2 py-0.5 text-[10px] font-bold text-white">
        {labelB}
      </div>
      <div
