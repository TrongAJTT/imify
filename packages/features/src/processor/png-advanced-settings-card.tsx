...
export function PngAdvancedSettingsCard({
  ...
  const sublabel = tags.length > 0 ? tags.join(" • ") : t("advanced.png.visualLossless", "Visual lossless optimizations")
  ...
  return (
    ...
    >
      <div className="space-y-3">
        <CheckboxCard
          icon={<Eraser size={16} />}
          title={t("advanced.png.cleanTransparentPixels", "Clean Transparent Pixels")}
          subtitle={cleanTransparentPixels ? t("advanced.enabled", "Enabled") : t("advanced.png.cleanTransparentPixelsSub", "Zero RGB where alpha is 0 to improve PNG compression")}
        ...
        <CheckboxCard
          ...
          subtitle={autoGrayscale ? t("advanced.enabled", "Enabled") : t("advanced.png.autoGrayscaleSub", "Prefer grayscale encode path when image has no chroma")}
        ...
        <CheckboxCard
          ...
          subtitle={oxipngCompression ? t("advanced.enabled", "Enabled") : t("advanced.png.oxipngCompressionSub", "Run OxiPNG pass for stronger lossless compression")}
        ...
        <CheckboxCard
          ...
          title={t("advanced.png.progressiveLoading", "Progressive Loading (Interlaced)")}
          tooltipLabel={t("advanced.png.progressiveLoading", "Progressive Loading (Interlaced)")}
          subtitle={
            progressiveInterlaced
              ? t("advanced.enabled", "Enabled")
              : t("advanced.png.progressiveLoadingSub", "Adam7 interlacing for progressive web loading")
          }
