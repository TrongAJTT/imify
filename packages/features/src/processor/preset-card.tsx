...
export function PresetCard({
  ...
  return (
    <div 
      ...
      className={`group relative flex cursor-pointer flex-col overflow-hidden rounded-lg border text-left transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-300 ${
        isActive 
    ...
    >
      ...
      <div 
        className={`pointer-events-none absolute inset-0 z-0 rounded-lg transition-opacity ${isActive ? "opacity-100" : "opacity-30 group-hover:opacity-100"}`} 
