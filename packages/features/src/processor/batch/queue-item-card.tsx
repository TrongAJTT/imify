...
import { useThumbnail } from "@imify/features/shared/hooks/use-thumbnail";
  ...
  return (
    <article className="relative flex flex-col overflow-hidden rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 shadow-sm">
      ...
      <div className="flex flex-1 flex-col p-3 pb-3">
        ...
        {item.message ? (
          <MutedText className="mt-2 text-[10px] leading-tight text-red-600 dark:text-red-400 bg-red-50 dark:bg-red-900/20 p-1.5 rounded">
            {item.message}
          </MutedText>
        ) : null}
      </div>
