...
export function QrReaderInfoPanel() {
  ...
  const showcase = {
    ...
    subtitle: t("showcase.subtitle", { defaultValue: "Scan QR codes instantly using your device's camera or by uploading image files (PNG/SVG) directly in your browser." }),
    ...
    faqs: [
      {
        question: t("showcase.faqs.0.question", { defaultValue: "Is scanning private and secure?" }),
        answer: t("showcase.faqs.0.answer", { defaultValue: "Yes, absolutely. Scanning is performed entirely in JavaScript on your local machine. No image data or video feeds are ever sent over the network." })
      },
      {
        question: t("showcase.faqs.1.question", { defaultValue: "Which formats can I upload?" }),
        answer: t("showcase.faqs.1.answer", { defaultValue: "You can drag and drop or upload any common image file, including **PNG**, **JPG**, **WebP**, and even vector **SVG** files containing QR codes." })
      },
      {
        question: t("showcase.faqs.2.question", { defaultValue: "What happens if a QR code has no valid URL?" }),
        answer: t("showcase.faqs.2.answer", { defaultValue: "The QR Reader decodes any content, including plain text, contact cards (vCards), Wi-Fi logins, and phone numbers. If it's a URL, a link will be provided to open it directly." })
      },
