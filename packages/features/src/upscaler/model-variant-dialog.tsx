  ...
  return (
    ...
    >
      <div className="contents" onClick={(event) => event.stopPropagation()}>
              ...
              return (
                <button
                  ...
                  className={`flex flex-col text-left p-4 rounded-xl border transition-all duration-200 outline-none select-none relative group h-full ${
                    isActive
                      ? "border-indigo-500 bg-indigo-50/20 dark:bg-indigo-950/10 shadow-md ring-1 ring-indigo-500"
                ...
                >
                  <div className="flex items-start justify-between w-full gap-2 mb-1.5">
                    ...
                    {isActive ? (
                      <span className="flex items-center justify-center w-5 h-5 rounded-full bg-indigo-500 text-white shrink-0 shadow-sm animate-in zoom-in-50 duration-150">
                  ...
                  <div className="flex flex-wrap items-center gap-2 mt-auto">
                    <span className="inline-flex items-center px-2 py-0.5 rounded text-[10px] font-semibold bg-indigo-100 text-indigo-700 dark:bg-indigo-950/40 dark:text-indigo-300 uppercase tracking-wider">
                      {model.usecase}
                    </span>
        ...
        <div className="p-4 rounded-xl bg-indigo-50/30 dark:bg-indigo-950/10 border border-indigo-100 dark:border-indigo-900/30 shadow-inner space-y-3.5 animate-in fade-in slide-in-from-bottom-2 duration-300">
