...
export const PRESET_OPTIONS: Array<{
  value: SplicingPreset;
  title: string;
  subtitle: string;
  icon: React.ReactNode;
}> = [
  {
    value: "stitch_vertical",
    title: "Stitch V",
    subtitle: "Vertical stack",
    icon: <Rows size={14} />,
  },
  {
    value: "stitch_horizontal",
    title: "Stitch H",
    subtitle: "Horizontal row",
    icon: <Columns size={14} />,
  },
  {
    value: "grid",
    title: "Grid",
    subtitle: "Fixed columns",
    icon: <Grid3x3 size={14} />,
  },
  {
    value: "bento",
    title: "Bento",
    subtitle: "Flow or columns",
    icon: <LayoutGrid size={14} />,
  },
];

export const BENTO_LAYOUT_OPTIONS: Array<{
...
export const STITCH_V_DIRECTION_OPTIONS: Array<{
...
export const STITCH_H_DIRECTION_OPTIONS: Array<{
  value: SplicingImageAppearanceDirection;
  label: string;
}> = [
...
export const GRID_DIRECTION_OPTIONS: Array<{
  value: SplicingImageAppearanceDirection;
  label: string;
}> = [
...
export const BENTO_V_DIRECTION_OPTIONS: Array<{
  value: SplicingImageAppearanceDirection;
  label: string;
}> = [
  { value: "top_to_bottom", label: "Top to bottom" },
...
export const BENTO_H_DIRECTION_OPTIONS: Array<{
  value: SplicingImageAppearanceDirection;
  label: string;
}> = [
  { value: "left_to_right", label: "Left to right" },
...
export const RESIZE_OPTIONS: Array<{
...
export function getBentoDefaultImageDirection(
...
export function deriveBentoLayoutMode(
  ...
  if (primary === "horizontal" && secondary === "vertical")
    return "fixed_vertical";
  if (primary === "vertical" && secondary === "horizontal")
    return "fixed_horizontal";
  if (primary === "vertical" && secondary === "vertical") return "vertical";
  if (primary === "horizontal" && secondary === "horizontal")
    return "horizontal";
  return "vertical";
}

export function getAvailableExportModes(
  preset: SplicingPreset,
  bentoMode?: BentoLayoutMode,
): SplicingExportMode[] {
