  ...
  return (
    ...
    >
      <div className="flex items-start gap-2">
        <div className="h-16 w-16 rounded-md overflow-hidden border border-slate-200 dark:border-slate-700 bg-slate-100 dark:bg-slate-800 shrink-0">
          <img
            src={asset.imageUrl}
            alt={asset.name}
        ...
        <div className="min-w-0 flex-1 space-y-1">
          ...
          <div className="flex items-center justify-end gap-1">
            <button
              ...
              aria-label={
                asset.enabled
                  ? t("assetListItem.hideAsset")
                  : t("assetListItem.showAsset")
              }
            >
            ...
            <ControlledPopover
              ...
              trigger={
                <button
                  ...
                  onPointerDown={(event) => event.stopPropagation()}
                  className="h-6 w-6 rounded-md border border-slate-200 dark:border-slate-700 flex items-center justify-center text-slate-500 hover:bg-slate-100 dark:hover:bg-slate-800"
                  aria-label={t("assetListItem.customizeAsset")}
                >
            ...
            >
              <div className="space-y-3 pointer-events-auto">
                ...
                >
                  <PencilLine size={14} />
                  {t("assetListItem.editInDraw")}
                </Button>

                <div className="text-[10px] font-semibold uppercase tracking-wide text-slate-500 dark:text-slate-400">
                  {t("assetListItem.opacity")}
                </div>
                ...
                <CheckboxCard
                  title={t("assetListItem.monochrome")}
                  subtitle={
                    monochrome.enabled
                      ? t("assetListItem.monochromeEnabled", {
                          color: monochrome.color,
                        })
                      : t("assetListItem.monochromeDisabled")
                  }
                ...
                {monochrome.enabled && (
                  <ColorPickerPopover
                    label={t("assetListItem.monochromeColor")}
                ...
                <div className="pt-2 border-t border-slate-200 dark:border-slate-700 space-y-2">
                  <div className="text-[10px] font-semibold uppercase tracking-wide text-slate-500 dark:text-slate-400">
                    {t("assetListItem.borderCornerTitle")}
                  </div>
                  <div className="grid grid-cols-2 gap-2">
                    <NumberInput
                      label={t("assetListItem.borderWidth")}
                    ...
                    />
                    <NumberInput
                      label={t("assetListItem.cornerRadius")}
                  ...
                  <ColorPickerPopover
                    label={t("assetListItem.borderColor")}
                    value={border.color}
                    onChange={(value) =>
                      onBorderChange(asset.id, {
                        ...border,
            ...
            <button
              ...
              aria-label={t("assetListItem.removeAsset")}
            >
              <Trash2 size={14} />
            </button>
          </div>
