...
export function RadioCard({
  ...
  const activeClasses = themeClasses.radioActiveFull;
  ...
  return (
    <label
      ...
      } ${disabled ? "opacity-60 cursor-not-allowed" : "cursor-pointer"} ${className} ${themeClasses.focusRing}`}
    >
        ...
        <div className="flex items-start gap-2 min-w-0">
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-1.5 flex-wrap">
              <span className="truncate text-[12px] font-bold text-slate-700 dark:text-slate-300">
                {title}
              </span>
              {badgeText && (
