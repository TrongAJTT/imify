...
export function DialogWrapper({
  ...
  return (
    <div className="fixed inset-0 z-modal flex items-center justify-center bg-slate-900/60 p-3 sm:p-4">
      <div
      ...
      >
        ...
        <div className="max-h-[calc(min(92vh,980px)-60px)] overflow-y-auto px-4 pb-4">
          {children}
        </div>
      </div>
    </div>
