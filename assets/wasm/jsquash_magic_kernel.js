...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('jsquash_magic_kernel_bg.wasm', globalThis.__magicKernelRuntimeUrl || self.location.href);
    }
    const imports = __wbg_get_imports();
...
if (isRunningInCloudFlareWorkers || isRunningInNode) {
  ...
  if (typeof globalThis.__magicKernelRuntimeUrl === 'undefined') {
    globalThis.__magicKernelRuntimeUrl = 'https://localhost';
  }
