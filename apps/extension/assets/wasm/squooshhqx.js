...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('squooshhqx_bg.wasm', globalThis.__hqxRuntimeUrl || self.location.href);
    }
    const imports = __wbg_get_imports();
...
if (isRunningInCloudFlareWorkers || isRunningInNode) {
  ...
  if (typeof globalThis.__hqxRuntimeUrl === 'undefined') {
    globalThis.__hqxRuntimeUrl = 'https://localhost';
  }
