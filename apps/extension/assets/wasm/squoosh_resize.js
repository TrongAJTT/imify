...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('squoosh_resize_bg.wasm', globalThis.__resizeRuntimeUrl || self.location.href);
    }
    const imports = __wbg_get_imports();
...
if (isRunningInCloudFlareWorkers || isRunningInNode) {
  ...
  if (typeof globalThis.__resizeRuntimeUrl === 'undefined') {
    globalThis.__resizeRuntimeUrl = 'https://localhost';
  }
