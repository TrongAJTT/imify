...
export const AttributionDialog: React.FC<AttributionDialogProps> = ({ isOpen, onClose }) => {
  return (
    <BaseDialog
      isOpen={isOpen}
      onClose={onClose}
      contentClassName="w-full max-w-3xl rounded-lg p-8"
    >
            ...
            >
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="self-start">
                    <span className="text-[9px] px-2 py-0.5 rounded-md bg-slate-100 dark:bg-slate-800 text-slate-400 dark:text-slate-500 font-black tracking-widest border border-slate-200/50 dark:border-slate-700/50">{item.license}</span>
                </div>
              </div>
            </a>
          </Tooltip>
