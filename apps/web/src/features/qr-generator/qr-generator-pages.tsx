...
export function QrGeneratorPage() {
  ...
  useEffect(() => {
    ...
    const unsubStart = useQrGeneratorStore.persist.onHydrate(() => setHydrated(false))
    const unsubFinish = useQrGeneratorStore.persist.onFinishHydration(() => setHydrated(true))
    return () => {
      try {
        unsubStart()
      } catch {}
