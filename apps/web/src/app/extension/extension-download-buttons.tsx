  ...
  return (
    <div className="flex flex-wrap items-center justify-center gap-6 pt-8">
      <Tooltip
        ...
        content={t("chromeStoreDesc", {
          defaultValue:
            "Install the stable version for Google Chrome. Recommended for most users.",
        })}
        variant="wide1"
      >
        <a
      ...
      <Tooltip
        ...
        content={t("edgeStoreDesc", {
          defaultValue:
            "Install the stable build for Microsoft Edge with the same core extension features.",
        })}
        variant="wide1"
      >
        <a
      ...
      <Tooltip
        ...
        content={t("firefoxStoreDesc", {
          defaultValue:
            "Install the stable version for Firefox to use context menu tools and extension-exclusive workflows.",
        })}
        variant="wide1"
      >
        <a
      ...
      <Tooltip
        ...
        content={t("githubReleasesDesc", {
          defaultValue:
            "Try the newest builds early (including experimental updates if available), or pick any specific version you want from the release list.",
        })}
        variant="wide2"
      >
        <Button
          variant="outline"
          className="h-14 font-semibold border-slate-200 dark:border-slate-800 transition-transform hover:scale-105 active:scale-95 px-5"
          asChild
        >
          <a
            href="https://github.com/TrongAJTT/imify/releases"
            target="_blank"
            rel="noopener noreferrer"
          ...
          >
            ...
            <div className="text-left leading-tight">
              <div className="text-[10px] uppercase tracking-wider text-slate-500">
                {t("downloadFrom", { defaultValue: "Download from" })}
              </div>
              <div className="text-sm">
                {t("githubReleasesLabel", { defaultValue: "GitHub Releases" })}
              </div>
            </div>
          </a>
        </Button>
